...
hex_values = re.findall(r'0x([0-9A-Fa-f]{2})', c_hex_data)

# Convert to a byte array
binary_data = bytes.fromhex(''.join(hex_values))

# Write the binary data to a file (optional)
with open("compressed_data.gz", "wb") as f:
    f.write(binary_data)

# Print first few bytes to confirm
print(f"Extracted {len(binary_data)} bytes")
print("Binary data sample:", binary_data[:20])